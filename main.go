...
func init() {
	...
	fs.IntVar(&maxESConnection, "max_es_conn", 0, "maximum elasticsearch connections. zero means default value.(100)")
	fs.BoolVar(&traceESWrite, "{trace_es_write}", false, "trace elasticsearch write operations for debugging")
}
